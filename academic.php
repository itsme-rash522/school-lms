    ...
    <div class="flex-shrink-0 p-3 bg-white main">
        ...
        <div class="sidebar">
            ...
            <div class="text-center">
                <a href="academic.php" class="fs-5 fw-semibold"
            ...
            <ul class="list-unstyled p-4">
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
                        ...
                        onclick="students();">
                        <i class="fa-solid fa-user-plus"></i>&nbsp;&nbsp;Register Students
                    </button>
                </li>
                ...
                <li class="mb-1">
                    <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 collapsed"
                        ...
                        onclick="addresult();">
                        <i class="fa-solid fa-list-check"></i>&nbsp;&nbsp;Assignment Marks
                    </button>
                </li>
