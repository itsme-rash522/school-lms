...
<body class="b4">
    ...
    <div class="container">
        <h2 class="text-center py-5 large" style="color: rgb(0, 0, 94);">Academic Officers of Royal College</h2>
        <div class="row">
            <table class="t">
            ...
            <div class="row mt-4 mb-3">
                <button class="col-2 btn btn-primary btn-dark btn-sm" onclick="admin_back();">
