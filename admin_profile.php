        ...
        <div class="container">
            <main>
                <div class="py-5 text-center">
                    ...
                    <label>Admin <img src="img/verify.png" width="20" /></label>
                </div>
                        ...
                        <form novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="adminid" placeholder="********"
                                            required>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-4 mb-3">
                                <button class="col-3 btn btn-primary btn-dark btn-sm" onclick="admin_back();">
