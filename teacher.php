    ...
    <div class="flex-shrink-0 p-3 bg-white main">
        ...
        <div class="sidebar">
            ...
            <div class="text-center">
                <a href="teacher.php" class="fs-5 fw-semibold"
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse show" id="home-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="addassignment.php"
                                    class="link-dark d-inline-flex text-decoration-none rounded"><i
                                        class="fa-solid fa-file-circle-plus"></i>&nbsp;&nbsp;Add New Assignment</a>
                            </li>
                            <li><a href="answersheet.php"
                                    class="link-dark d-inline-flex text-decoration-none rounded"><i
                                        class="fa-solid fa-file-pen"></i>&nbsp;&nbsp;View Answer Sheets</a>
                            </li>
                            <li><a href="addresult.php" class="link-dark d-inline-flex text-decoration-none rounded"><i
                                        class="fa-solid fa-list-check"></i>&nbsp;&nbsp;Add Assignment Marks</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse" id="orders-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li><a href="teacher_profile.php#change_password"
                                    class="link-dark d-inline-flex text-decoration-none rounded"><i
